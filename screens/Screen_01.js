    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.style2}>
                ...
                style={{width: 150, height:150, marginLeft: 215,}}></Image>
                <Image s></Image>
                <Image source={require('../assets/Data/Image_95.png')} 
                style={{width: 150, height:150, marginLeft: 20, marginTop:-25}}></Image>
                <Image source={require('../assets/Data/Image_97.png')} 
                style={{width: 150, height:150, marginLeft: 200, marginTop: 30}}></Image>
            </View>
